...
class DeInstiController extends Controller
{
    public function __construct()
{
    ...
    public function index(){
        ...
        return view('de_registar.institute.index',compact('data'));
       }
       public function create(){
        return view('de_registar.institute.create');
       }
       ...
       public function store(Request $request){
        ...
        return redirect('de_registar/institutes')->with($notification);

       }

       public function view($id){
        $value = Institute::find($id);
        return view('de_registar.institute.view',compact('value'));
       }

       public function edit($id){
        $value = Institute::find($id);
        return view('de_registar.institute.edit',compact('value'));
       }
