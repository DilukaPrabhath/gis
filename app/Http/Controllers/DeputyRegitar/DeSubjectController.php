...
class DeSubjectController extends Controller
{
    public function __construct()
{
    ...
    public function create(){
        $data = Subject::all();
        return view('de_registar.subject.create',compact('data'));
    ...
    public function store(Request $request){
        ...
        return redirect('de_registar/subjects')->with($notification);
       ...
       public function edit($id){
        ...
        $tbl = Subject::all();
        return view('de_registar.subject.edit',compact('data','tbl'));
       }
