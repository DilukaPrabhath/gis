...
class DeAdmitionCon extends Controller
{
    ...
    public function index(){
        $data = Admition::all();
        return view('de_registar.admition.index',compact('data'));
       }

       public function Create(){
        // $data = Admition::all();
        return view('de_registar.admition.create');
       }
       ...
       public function store(Request $request){
            ...
            return redirect('de_registar/admition')->with($notification);
       }
       ...
       public function print($id){
        ...
        return view('de_registar.admition.print',compact('data','ins'));
    }
