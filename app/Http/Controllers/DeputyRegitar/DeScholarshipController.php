...
class DeScholarshipController extends Controller
{
    public function __construct()
{
    ...
    public function index(){
        return view('de_registar.scholarship_request.index');
       }

       public function create(){

        return view('de_registar.scholarship_request.create');
       }
       ...
       public function store(Request $request){
        ...
        return redirect('de_registar/scholarship')->with($notification);
