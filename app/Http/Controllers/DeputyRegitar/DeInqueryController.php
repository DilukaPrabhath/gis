...
class DeInqueryController extends Controller
{
    public function __construct()
{
    ...
    public function index(){
        ...
        return view('de_registar.inquery.index',compact('inq'));
       }

       public function create(){
        $institute = Institute::where('status',1)->get();
        return view('de_registar.inquery.create',compact('institute'));
       }
      ...
      $sibl = Siblin::where('s_id',$pid)->get();
        ...
        $ttn1 = Str::random(6);
        $ttn2 = Str::random(6);
        return view('de_registar.inquery.view',compact('data','institute','grade','ttn1','ttn2','sibl','fa','mo','st'));
       }

       public function edit($pid){
        $data  = Student::find($pid);
        return view('de_registar.inquery.edit',compact('data'));
       }
