...
class DeComplaintsController extends Controller
{
    public function __construct()
{
    ...
    public function create(){
        return view('de_registar.complain.create');
    }
    ...
    public function store(Request $request){
        //return $request;
          ...
          return redirect('de_registar/complaints/create')->with($notification);
         }

    public function view(){
        return view('de_registar.complain.view');
    }

    public function edit(){
        return view('de_registar.complain.edit');
    }
