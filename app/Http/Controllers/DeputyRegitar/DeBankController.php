...
class DeBankController extends Controller
{
    public function __construct()
{
    ...
    public function create(){
        $data = Bank::all();
        return view('de_registar.bank.create',compact('data'));
       }
       ...
       public function store(Request $request){
        ...
        return redirect('de_registar/banks')->with($notification);
       ...
       public function edit($id){
        $bnk = Bank::find($id);
        $data = Bank::all();
        return view('de_registar.bank.edit',compact('data','bnk'));
       }
