...
class DeEventController extends Controller
{
    public function __construct()
{
    ...
    public function index(){
       $data = Event::tbldata();
        return view('de_registar.event.index',compact('data'));
    }
    ...
    public function create(){
        ...
        return view('de_registar.event.create',compact('ins','t_n1','t_n2'));
    }
    ...
    public function store(Request $request){
        ...
        return redirect('de_registar/events')->with($notification);

    }

    public function view($id){
     $evet = Event::data($id);
        return view('de_registar.event.view',compact('evet'));
    }

    public function edit($id){
        $evet = Event::data($id);
        $ins = Institute::where('status',1)->get();
        return view('de_registar.event.edit',compact('evet','ins'));
    }
