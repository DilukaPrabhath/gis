...
class DeApplicatPayController extends Controller
{
    ...
    public function index(){
        ...
        return view('de_registar.application_pay.index',compact('tbl'));
       }

       public function create(){
        return view('de_registar.application_pay.create');
       }
       ...
       public function store(Request $request){
        ...
        return redirect('de_registar/application_pay')->with($notification);
       }

       public function view($id){
        return view('de_registar.application_pay.view');
    }

       public function print($id){
           $data = ApplicationPay::find($id);
           $ins = Institute::find($data->institute_id);
           return view('de_registar.application_pay.print',compact('data','ins'));
       }
