...
class DeTktPriceController extends Controller
{
    public function __construct()
{
    ...
    public function index(){
        $data = Event::tbldata();
        return view('de_registar.eventticket.index',compact('data'));
    }
    ...
    public function create($id){
        ...
        return view('de_registar.eventticket.create',compact('eve','data','tic','t_id'));
    }
    ...
    public function view($id){
        ...
        return view('de_registar.eventticket.view',compact('data','evet'));
    }
    ...
    public function store(Request $request){
        ...
        $id = $request->t_id;
        return redirect('de_registar/event_tickets/create/'.$id)->with($notification);
    ...
    public function edit($id,$t_id){
        ...
        $t_id = $t_id;
        $tic = EventTicket::datatble($id);
        return view('de_registar.eventticket.edit',compact('ticedit','tic','t_id','evid'));
    }
