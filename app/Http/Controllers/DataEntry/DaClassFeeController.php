...
class DaClassFeeController extends Controller
{
    public function __construct()
{
    ...
    public function index(){
        ...
        $data = Institute::all();
        return view('data_entry.classfee.index',compact('data'));
    }
    ...
    public function create($id){
        ...
        return view('data_entry.classfee.create',compact('cls','grd','c_id','sch','syl','cls_n'));
    }
    ...
    public function store(Request $request){
        ...
        $id = $request->c_id;
         ...
         return redirect('data_entry/classfee/create/'.$id)->with($notification);
    ...
    public function view($id){
        ...
        $ins_id = $id;
        $grd = InstClassFee::data($ins_id);
        return view('data_entry.classfee.view',compact('grd','institute'));
    }
    ...
    public function edit($ins_id,$id){
        ...
        $cls_id = $id;
        $grd = InstClassFee::data($ins_id);
        return view('data_entry.classfee.edit',compact('fee','ins_id','grd','sch','cls','cls_id'));
    }
    ...
    public function update(Request $request,$id){
        ...
        $cid = $request->c_id;
        return redirect('data_entry/classfee/create/'.$cid)->with($notification);
    }
