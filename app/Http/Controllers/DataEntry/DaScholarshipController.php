...
class DaScholarshipController extends Controller
{
    public function __construct()
{
    ...
    public function index(){
        return view('data_entry.scholarship_request.index');
       }

       public function create(){

        return view('data_entry.scholarship_request.create');
       }
       ...
       public function store(Request $request){
        ...
        return redirect('data_entry/scholarship')->with($notification);
