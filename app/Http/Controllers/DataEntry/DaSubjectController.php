...
class DaSubjectController extends Controller
{
    public function __construct()
{
    ...
    public function create(){
        $data = Subject::all();
        return view('data_entry.subject.create',compact('data'));
    ...
    public function store(Request $request){
        ...
        return redirect('data_entry/subjects')->with($notification);
       ...
       public function edit($id){
        ...
        $tbl = Subject::all();
        return view('data_entry.subject.edit',compact('data','tbl'));
       }
