...
class DaAdmitionCon extends Controller
{
    ...
    public function index(){
        $data = Admition::where('school_id',Auth::user()->ins_id)->get();
        return view('data_entry.admition.index',compact('data'));
       }

       public function Create(){
        // $data = Admition::all();
        return view('data_entry.admition.create');
       }
       ...
       public function store(Request $request){
            ...
            return redirect('data_entry/admition')->with($notification);
       }
       ...
       public function print($id){
        ...
        return view('data_entry.admition.print',compact('data','ins'));
    }
