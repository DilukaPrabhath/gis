...
class DaInstiController extends Controller
{
    public function __construct()
{
    ...
    public function index(){
        ...
        return view('data_entry.institute.index',compact('data'));
       }
       public function create(){
        return view('data_entry.institute.create');
       }
       ...
       public function store(Request $request){
        ...
        return redirect('data_entry/institutes')->with($notification);

       }

       public function view($id){
        $value = Institute::find($id);
        return view('data_entry.institute.view',compact('value'));
       }

       public function edit($id){
        $value = Institute::find($id);
        return view('data_entry.institute.edit',compact('value'));
       }
