...
class DaPaymentController extends Controller
{
    public function __construct()
{
    ...
    public function index(){
        ...
        return view('data_entry.payment.index',compact('tbl'));
       }
       ...
       public function create(){
        return view('data_entry.payment.create');
       }


       public function view(){
        return view('data_entry.payment.view');
       }

       public function edit(){
        return view('data_entry.payment.edit');
       }

       public function old_payment(){
        return view('data_entry.payment.old_payment');
       }
       ...
       public function student_select(Request $request){
         ...
         public function store(Request $request){
            ...
            $insdata = Institute::find($stud_id[0]->institute);
                ...
                $data = [
                  ...
                  Mail::send('data_entry.emails.mail_fee', $data, function($message) use ($data) {
                    $message->to($data['email'])
                    ->from('task123test123@gmail.com','test mail')
                    ->subject($data['subject']);
                  });

                  Mail::send('data_entry.emails.mail_fee', $data2, function($message) use ($data) {
                    $message->to($data['email'])
                    ->from('task123test123@gmail.com','test mail')
                    ->subject($data['subject']);
                  });
                ...
                return redirect('data_entry/payments')->with($notification);
         ...
         public function print($id){
            ...
            return view('data_entry.payment.print',compact('data','ins','snum'));
        }
