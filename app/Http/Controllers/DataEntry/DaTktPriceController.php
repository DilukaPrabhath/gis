...
class DaTktPriceController extends Controller
{
    public function __construct()
{
    ...
    public function index(){
        $data = Event::tbldata();
        return view('data_entry.eventticket.index',compact('data'));
    }
    ...
    public function create($id){
        ...
        return view('data_entry.eventticket.create',compact('eve','data','tic','t_id'));
    }
    ...
    public function view($id){
        ...
        return view('data_entry.eventticket.view',compact('data','evet'));
    }
