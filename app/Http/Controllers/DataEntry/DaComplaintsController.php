...
class DaComplaintsController extends Controller
{
    public function __construct()
{
    ...
    public function create(){
        return view('data_entry.complain.create');
    }
    ...
    public function store(Request $request){
        //return $request;
          ...
          return redirect('data_entry/complaints/create')->with($notification);
         }

    public function view(){
        return view('data_entry.complain.view');
    }

    public function edit(){
        return view('data_entry.complain.edit');
    }
