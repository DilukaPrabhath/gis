...
class DaStudentController extends Controller
{
    public function __construct()
{
    ...
    public function index(){
        ...
        return view('data_entry.student.index',compact('reg'));
       }
       ...
       if( $temp ){
        ...
        return redirect('data_entry/inqueries')->with($notification);
       }

       public function create(){
        return view('data_entry.student.create');
       }
      ...
      if($st == 5 || $st == 6){
        ...
        return view('data_entry.student.student_view',compact('data','institute','grade','sibl','fa','mo','st'));
    ...
    //    $tabdata = Siblin::where('s_id',$id)->get();
       ...
       if($sql){
        ...
        $sibl = Siblin::where('s_id',$id)->get();
        // $institute = Institute::where('status',1)->get();
        return view('data_entry.student.student_edit',compact('data','institute','grade','sibl','fa','mo','st','ttn1','ttn2'));
       }
...
public function tempremove(Request $request){
     ...
     return $this->createReservicetbl($ttn1, $ttn2);
       ...
       if( $temp ){
        ...
        return redirect('data_entry/school/students/table')->with($notification);
       }
