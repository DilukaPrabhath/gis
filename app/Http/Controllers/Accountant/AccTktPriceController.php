...
class AccTktPriceController extends Controller
{
    public function __construct()
{
    ...
    public function index(){
        $data = Event::tbldata();
        return view('accountant.eventticket.index',compact('data'));
    }
    ...
    public function create($id){
        ...
        return view('accountant.eventticket.create',compact('eve','data','tic','t_id'));
    }
    ...
    public function view($id){
        ...
        return view('accountant.eventticket.view',compact('data','evet'));
    }
