...
class AccApplicatPayController extends Controller
{
    ...
    public function index(){
        ...
        return view('accountant.application_pay.index',compact('tbl'));
       }

       public function create(){
        return view('accountant.application_pay.create');
       }
       ...
       public function store(Request $request){
        ...
        return redirect('accountant/application_pay')->with($notification);
       }

       public function view($id){
        return view('accountant.application_pay.view');
    }

       public function print($id){
           $data = ApplicationPay::find($id);
           $ins = Institute::find($data->institute_id);
           return view('accountant.application_pay.print',compact('data','ins'));
       }
