...
class AccSubjectController extends Controller
{
    public function __construct()
{
    ...
    public function create(){
        $data = Subject::all();
        return view('accountant.subject.create',compact('data'));
    ...
    public function store(Request $request){
        ...
        return redirect('accountant/subjects')->with($notification);
       ...
       public function edit($id){
        ...
        $tbl = Subject::all();
        return view('accountant.subject.edit',compact('data','tbl'));
       }
