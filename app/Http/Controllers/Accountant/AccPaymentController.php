...
class AccPaymentController extends Controller
{
    public function __construct()
{
    ...
    public function index(){
        ...
        return view('accountant.payment.index',compact('tbl'));
       }
       ...
       public function create(){
        return view('accountant.payment.create');
       }


       public function view(){
        return view('accountant.payment.view');
       }

       public function edit(){
        return view('accountant.payment.edit');
       }

       public function old_payment(){
        return view('accountant.payment.old_payment');
       }
       ...
       public function student_select(Request $request){
         ...
         public function store(Request $request){
            ...
            $insdata = Institute::find($stud_id[0]->institute);
                ...
                $data = [
                  ...
                  Mail::send('accountant.emails.mail_fee', $data, function($message) use ($data) {
                    $message->to($data['email'])
                    ->from('task123test123@gmail.com','test mail')
                    ->subject($data['subject']);
                  });

                  Mail::send('accountant.emails.mail_fee', $data2, function($message) use ($data) {
                    $message->to($data['email'])
                    ->from('task123test123@gmail.com','test mail')
                    ->subject($data['subject']);
                  });
                ...
                return redirect('accountant/payments')->with($notification);
         ...
         public function print($id){
            ...
            return view('accountant.payment.print',compact('data','ins','snum'));
        }
