...
class AccScholarshipController extends Controller
{
    public function __construct()
{
    ...
    public function index(){
        return view('accountant.scholarship_request.index');
       }

       public function create(){

        return view('accountant.scholarship_request.create');
       }
       ...
       public function store(Request $request){
        ...
        return redirect('accountant/scholarship')->with($notification);
