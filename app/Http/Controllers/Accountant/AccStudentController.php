...
class AccStudentController extends Controller
{
    public function __construct()
{
    ...
    public function index(){
        ...
        return view('accountant.student.index',compact('reg'));
       }
       ...
       if( $temp ){
        ...
        return redirect('accountant/inqueries')->with($notification);
       }

       public function create(){
        return view('accountant.student.create');
       }
      ...
      if($st == 5 || $st == 6){
        ...
        return view('accountant.student.student_view',compact('data','institute','grade','sibl','fa','mo','st'));
    ...
    //    $tabdata = Siblin::where('s_id',$id)->get();
       ...
       if($sql){
        ...
        $sibl = Siblin::where('s_id',$id)->get();
        // $institute = Institute::where('status',1)->get();
        return view('accountant.student.student_edit',compact('data','institute','grade','sibl','fa','mo','st','ttn1','ttn2'));
       }
...
public function tempremove(Request $request){
     ...
     return $this->createReservicetbl($ttn1, $ttn2);
       ...
       if( $temp ){
        ...
        return redirect('accountant/school/students/table')->with($notification);
       }
