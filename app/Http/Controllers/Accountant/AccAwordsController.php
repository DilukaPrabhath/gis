...
class AccAwordsController extends Controller
{
    public function index(){
        return view('accountant.acc_aworde.index');
       }

    public function create(){
        return view('accountant.acc_aworde.create');
       }
    ...
    public function store(Request $request){
      //return $request;
        ...
        return redirect('accountant/awards/create')->with($notification);
       }

    public function view(){
        return view('accountant.acc_aworde.view');
       }

    public function edit(){
        return view('accountant.acc_aworde.edit');
       }
