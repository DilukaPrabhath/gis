...
class AccInstiController extends Controller
{
    public function __construct()
{
    ...
    public function index(){
        ...
        return view('accountant.institute.index',compact('data'));
       }
       public function create(){
        return view('accountant.institute.create');
       }
       ...
       public function store(Request $request){
        ...
        return redirect('accountant/institutes')->with($notification);

       }

       public function view($id){
        $value = Institute::find($id);
        return view('accountant.institute.view',compact('value'));
       }

       public function edit($id){
        $value = Institute::find($id);
        return view('accountant.institute.edit',compact('value'));
       }
