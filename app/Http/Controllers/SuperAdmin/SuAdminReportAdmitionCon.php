...
class SuAdminReportAdmitionCon extends Controller
{
    public function index(){
        $school = Institute::where('status',1)->get();
        return view('superadmin.reports.admition_index',compact('school'));
    }
    ...
    public function date_vi(Request $request){
        ...
        $data = $request;
        return view('superadmin.reports.admition_loard',compact('app_repo','school','data'));
    }
