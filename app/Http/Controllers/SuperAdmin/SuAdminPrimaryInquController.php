...
class SuAdminPrimaryInquController extends Controller
{
    public function __construct()
{
    ...
    public function index(){
        ...
        return view('superadmin.primary_inquery.index',compact('inq'));
       }

       public function create(){
        $institute = Institute::where('status',1)->where('pre_or_sch',1)->get();
        return view('superadmin.primary_inquery.create',compact('institute'));
       }
       ...
       public function edit($pid){
        ...
        return view('superadmin.primary_inquery.edit',compact('data'));
       }
      ...
      $sibl = Siblin::where('s_id',$pid)->get();
        ...
        $ttn1 = Str::random(6);
        $ttn2 = Str::random(6);
        return view('superadmin.primary_inquery.view',compact('data','institute','grade','ttn1','ttn2','sibl','fa','mo','st'));
       }
