...
class SuAdminPaymentController extends Controller
{
    public function __construct()
{
    ...
    public function index(){
        ...
        return view('superadmin.payment.index',compact('tbl'));
       }
       ...
       public function view(){
        return view('superadmin.payment.view');
       }
       ...
       public function old_payment(){
        return view('superadmin.payment.old_payment');
       }
       ...
       public function student_select(Request $request){
         ...
         public function store(Request $request){
            ...
            $insdata = Institute::find($stud_id[0]->institute);
                ...
                $data = [
                  ...
                  Mail::send('superadmin.emails.mail_fee', $data, function($message) use ($data) {
                    $message->to($data['email'])
                    ->from('task123test123@gmail.com','test mail')
                    ->subject($data['subject']);
                  });

                  Mail::send('superadmin.emails.mail_fee', $data2, function($message) use ($data) {
                    $message->to($data['email'])
                    ->from('task123test123@gmail.com','test mail')
                    ->subject($data['subject']);
                  });
                ...
                return redirect('superadmin/payments')->with($notification);
         ...
         public function print($id){
            ...
            return view('superadmin.payment.print',compact('data','ins','snum'));
        }
