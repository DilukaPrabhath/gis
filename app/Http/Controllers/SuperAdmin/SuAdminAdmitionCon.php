...
class SuAdminAdmitionCon extends Controller
{
    ...
    public function index(){
        $data = Admition::all();
        return view('superadmin.admition.index',compact('data'));
       }

       public function Create(){
        // $data = Admition::all();
        return view('superadmin.admition.create');
       }
       ...
       public function store(Request $request){
            ...
            return redirect('superadmin/admition')->with($notification);
       }
       ...
       public function print($id){
        ...
        return view('superadmin.admition.print',compact('data','ins'));
    }
