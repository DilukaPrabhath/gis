...
class SuAdminAwordsController extends Controller
{

    public function index(){
        return view('superadmin.acc_aworde.index');
       }

    public function create(){
        return view('superadmin.acc_aworde.create');
       }
    ...
    public function store(Request $request){
      //return $request;
        ...
        return redirect('superadmin/awards/create')->with($notification);
       }

    public function view(){
        return view('superadmin.acc_aworde.view');
       }

    public function edit(){
        return view('superadmin.acc_aworde.edit');
       }
