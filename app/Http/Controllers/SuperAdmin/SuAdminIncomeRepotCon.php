...
class SuAdminIncomeRepotCon extends Controller
{
    public function index(){
        $school = Institute::where('status',1)->get();
        return view('superadmin.reports.income_index',compact('school'));
    }
    ...
    public function date_vise(Request $request){
     ...
     //return   $class_fee = ClassFeePayment::datevise($request);
        $school = Institute::where('status',1)->get();
        return view('superadmin.reports.income_loard',compact('data','school'));
    }
    ...
    public function date_range(Request $request){
        ...
        $school = Institute::where('status',1)->get();
        return view('superadmin.reports.income_loard',compact('school','data'));
    }
