...
class SuAdminStudentController extends Controller
{
    public function __construct()
{
    ...
    public function index(){
        ...
        return view('superadmin.student.index',compact('reg'));
       }
       ...
       if( $temp ){
        ...
        return redirect('superadmin/inqueries')->with($notification);
       }
      ...
      if($st == 5 || $st == 6){
        ...
        return view('superadmin.student.student_view',compact('data','institute','grade','sibl','fa','mo','st'));
    ...
    //    $tabdata = Siblin::where('s_id',$id)->get();
       ...
       if($sql){
        ...
        $sibl = Siblin::where('s_id',$id)->get();
        // $institute = Institute::where('status',1)->get();
        return view('superadmin.student.student_edit',compact('data','institute','grade','sibl','fa','mo','st','ttn1','ttn2'));
       }
...
public function tempremove(Request $request){
     ...
     return $this->createReservicetbl($ttn1, $ttn2);
       ...
       if( $temp ){
        ...
        return redirect('superadmin/school/students/table')->with($notification);
       }
