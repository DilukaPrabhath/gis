...
class SuAdmScholarshipController extends Controller
{
    public function __construct()
{
    ...
    public function index(){
        return view('superadmin.scholarship_request.index');
       }

       public function create(){

        return view('superadmin.scholarship_request.create');
       }
       ...
       public function store(Request $request){
        ...
        return redirect('superadmin/scholarship')->with($notification);
