...
class SuAdminComplaintsController extends Controller
{
    public function __construct()
{
    ...
    public function create(){
        return view('superadmin.complain.create');
    }
    ...
    public function store(Request $request){
        //return $request;
          ...
          return redirect('superadmin/complaints/create')->with($notification);
         }

    public function view(){
        return view('superadmin.complain.view');
    }

    public function edit(){
        return view('superadmin.complain.edit');
    }
