...
class SuAdmInstiController extends Controller
{
    public function __construct()
{
    ...
    public function index(){
        ...
        return view('superadmin.institute.index',compact('data'));
       }
       ...
       public function view($id){
        ...
        return view('superadmin.institute.view',compact('value'));
       }

       public function edit($id){
        $value = Institute::find($id);
        return view('superadmin.institute.edit',compact('value'));
       }
