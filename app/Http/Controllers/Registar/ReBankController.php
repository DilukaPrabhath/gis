...
class ReBankController extends Controller
{
    public function __construct()
{
    ...
    public function create(){
        $data = Bank::all();
        return view('registar.bank.create',compact('data'));
       }
       ...
       public function store(Request $request){
        ...
        return redirect('registar/banks')->with($notification);
       ...
       public function edit($id){
        $bnk = Bank::find($id);
        $data = Bank::all();
        return view('registar.bank.edit',compact('data','bnk'));
       }
