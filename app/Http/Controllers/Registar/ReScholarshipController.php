...
class ReScholarshipController extends Controller
{
    public function __construct()
{
    ...
    public function index(){
        return view('registar.scholarship_request.index');
       }

       public function create(){

        return view('registar.scholarship_request.create');
       }
       ...
       public function store(Request $request){
        ...
        return redirect('registar/scholarship')->with($notification);
