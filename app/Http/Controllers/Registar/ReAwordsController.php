...
class ReAwordsController extends Controller
{

    public function index(){
        return view('registar.acc_aworde.index');
       }

    public function create(){
        return view('registar.acc_aworde.create');
       }
    ...
    public function store(Request $request){
      //return $request;
        ...
        return redirect('registar/awards/create')->with($notification);
       }

    public function view(){
        return view('registar.acc_aworde.view');
       }

    public function edit(){
        return view('registar.acc_aworde.edit');
       }
