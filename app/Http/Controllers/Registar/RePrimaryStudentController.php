...
class RePrimaryStudentController extends Controller
{
    public function __construct()
{
    ...
    public function index(){
        ...
        return view('registar.nersary_student.index',compact('reg'));
    }
    public function update(Request $request,$id){
       ...
       $student->save();
        ...
        return redirect('registar/primary/inqueries')->with($notification);
       }
      ...
      if($st == 5 || $st == 6){
        ...
        return view('registar.nersary_student.student_view',compact('data','institute','grade','sibl','fa','mo','st'));
      ...
      if($st == 5 || $st == 6){
        ...
        return view('registar.nersary_student.student_edit',compact('data','institute','grade','sibl','fa','mo','st'));
   ...
   $student->save();
    ...
    return redirect('registar/nursary/students/table')->with($notification);
   }
}
