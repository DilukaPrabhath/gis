...
class ReSubjectController extends Controller
{
    public function __construct()
{
    ...
    public function create(){
        $data = Subject::all();
        return view('registar.subject.create',compact('data'));
    ...
    public function store(Request $request){
        ...
        return redirect('registar/subjects')->with($notification);
       ...
       public function edit($id){
        ...
        $tbl = Subject::all();
        return view('registar.subject.edit',compact('data','tbl'));
       }
