...
class ReAdmitionCon extends Controller
{
    ...
    public function index(){
        $data = Admition::all();
        return view('registar.admition.index',compact('data'));
       }

       public function Create(){
        // $data = Admition::all();
        return view('registar.admition.create');
       }
       ...
       public function store(Request $request){
            ...
            return redirect('registar/admition')->with($notification);
       }
       ...
       public function print($id){
        ...
        return view('registar.admition.print',compact('data','ins'));
    }
