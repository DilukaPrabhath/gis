    ...
    public function __construct()
{
   ...
   public function index(){
    ...
    return view('registar.user.index',compact('usr_tbl'));
   }
   public function create(){
    $user_type = UserRole::where('status',1)->get();
    $school = Institute::where('status',1)->get();
    return view('registar.user.create',compact('school','user_type'));
   }
   ...
   public function view($id){
    ...
    return view('registar.user.view',compact('adminuser','nm','school','u_tyo'));
   }
   ...
   public function edit($id){
    ...
    $data = User::find($id);
    return view('registar.user.edit',compact('user_type','school','data'));
   }
   ...
   return redirect('registar/users')->with($notification);
   }

   public function update_pas_view($id){
       $id = $id;
    return view('registar.user.password',compact('id'));
   }
   ...
   public function profileView(){
    ...
    $school = Institute::where('id',$adminuser->ins_id)->first();
    $u_tyo = UserRole::where('id',$adminuser->user_role)->first();
    return view('registar.profile.profile_view',compact('school','u_tyo','adminuser'));
   }
   ...
   public function profileEdit(){
    ...
    return view('registar.profile.profile_update',compact('user_type','school','data','u_tyo'));
   }
   ...
   public function profile_update(Request $request){
    ...
    $notification = array(
     ...
     'alert-type' => 'Success'
      ...
      return redirect('registar/profile')->with($notification);
      }

      public function profile_pass_update(Request $request){
        return view('registar.profile.profile_pasword');
      }
