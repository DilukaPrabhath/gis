...
class ReActiviSetController extends Controller
{
    ...
    public function __construct()
{
    ...
    public function index(){
        return view('registar.activity.index');
       }

       public function create(){
        $data = Activity::all();
        return view('registar.activity.create',compact('data'));
       }
       ...
       public function store(Request $request){
        ...
        return redirect('registar/activities/create')->with($notification);
       }

       public function view(){
        return view('registar.activity.view');
       }

       public function edit($id){
        $tbl = Activity::all();
        $data = Activity::find($id);
        return view('registar.activity.edit',compact('data','tbl'));
       }
