...
class ReInstiController extends Controller
{
    public function __construct()
{
    ...
    public function index(){
        ...
        return view('registar.institute.index',compact('data'));
       }
       public function create(){
        return view('registar.institute.create');
       }
       ...
       public function store(Request $request){
        ...
        return redirect('registar/institutes')->with($notification);

       }

       public function view($id){
        $value = Institute::find($id);
        return view('registar.institute.view',compact('value'));
       }

       public function edit($id){
        $value = Institute::find($id);
        return view('registar.institute.edit',compact('value'));
       }
