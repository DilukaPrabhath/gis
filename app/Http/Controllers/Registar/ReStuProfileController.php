...
class ReStuProfileController extends Controller
{
    public function __construct()
{
    ...
    public function index(Request $request){
        //return "HI";
        return view('registar.studentprofile.index');
    }
    ...
    public function profile_search(Request $request){
        ...
        return view('registar.studentprofile.profile',compact('stu_data','grd','father','mother','data','school','stu_img_count','stu_img','non_acc_award','acc_award','complain'));
    }
