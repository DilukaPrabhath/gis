    ...
    public function __construct()
{
    ...
    public function index(){
        ...
        return view('registar.payment.index',compact('tbl'));
       }
       ...
       public function create(){
        return view('registar.payment.create');
       }


       public function view(){
        return view('registar.payment.view');
       }

       public function edit(){
        return view('registar.payment.edit');
       }

       public function old_payment(){
        return view('registar.payment.old_payment');
       }
       ...
       public function student_select(Request $request){
         ...
         public function store(Request $request){
            ...
            $insdata = Institute::find($stud_id[0]->institute);
                ...
                $data = [
                  ...
                  Mail::send('registar.emails.mail_fee', $data, function($message) use ($data) {
                    $message->to($data['email'])
                    ->from('task123test123@gmail.com','test mail')
                    ->subject($data['subject']);
                  });

                  Mail::send('registar.emails.mail_fee', $data2, function($message) use ($data) {
                    $message->to($data['email'])
                    ->from('task123test123@gmail.com','test mail')
                    ->subject($data['subject']);
                  });
                ...
                return redirect('registar/payments')->with($notification);
         ...
         public function print($id){
            ...
            return view('registar.payment.print',compact('data','ins','snum'));
        }
