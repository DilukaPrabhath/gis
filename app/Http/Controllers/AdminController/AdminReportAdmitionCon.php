...
class AdminReportAdmitionCon extends Controller
{
    public function index(){
        $school = Institute::where('status',1)->get();
        return view('admin.reports.admition_index',compact('school'));
    }
    ...
    public function date_vi(Request $request){
        ...
        $data = $request;
        return view('admin.reports.admition_loard',compact('app_repo','school','data'));
    }
