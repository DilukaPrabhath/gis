    ...
    public function __construct()
{
   ...
   public function index(){
    $usr_tbl = User::data()->where('id','!=',0)->where('user_role','!=',6);
    return view('admin.user.index',compact('usr_tbl'));
   }
   public function create(){
    $user_type = UserRole::where('status',1)->where('id','!=',6)->get();
    $school = Institute::where('status',1)->get();
    return view('admin.user.create',compact('school','user_type'));
   }
   ...
   public function view($id){
    ...
    return view('admin.user.view',compact('adminuser','nm','school','u_tyo'));
   }
   ...
   public function edit($id){
    ...
    $data = User::find($id);
    return view('admin.user.edit',compact('user_type','school','data'));
   }
   ...
   public function profileView(){
    ...
    $school = Institute::where('id',$adminuser->ins_id)->first();
    $u_tyo = UserRole::where('id',$adminuser->user_role)->first();
    return view('admin.profile.profile_view',compact('school','u_tyo','adminuser'));
   }
   ...
   public function profileEdit(){
    ...
    return view('admin.profile.profile_update',compact('user_type','school','data','u_tyo'));
   }
