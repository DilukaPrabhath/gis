...
class AdminAdmitionCon extends Controller
{
    ...
    public function index(){
        $data = Admition::all();
        return view('admin.admition.index',compact('data'));
       }

       public function Create(){
        // $data = Admition::all();
        return view('admin.admition.create');
       }
       ...
       public function store(Request $request){
            ...
            return redirect('admin/admition')->with($notification);
       }
