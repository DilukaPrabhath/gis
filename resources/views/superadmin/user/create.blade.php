            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{url('superadmin/users/store')}}" method="POST" autocomplete="off" id="regForm" enctype="multipart/form-data">
                            @csrf
                        <div class="row">
                            <div class="col-lg-6">
        ...
        $(document).ready(function() {
            $("#regForm").validate({
                rules: {
                    ...
                    nic: {
                        required: true,
                        remote:'/superadmin/validate-nic',
                    ...
                    mobile: {
                        ...
                        maxlength: 10,
                        number: true,
                        remote:'/superadmin/validate-mobile',
                    },
                    usertype: {
                        required: true,
                    },
