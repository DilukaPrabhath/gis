            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{url('superadmin/subjects/store')}}" method="POST" autocomplete="off" id="regForm" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <a type="button" href="{{url('superadmin/subjects')}}" class="btn btn-primary waves-effect waves-light" style="margin-left: 5px;"><i class="mdi mdi-close" style="margin-right: 5px;"></i>Close</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{url('superadmin/subjects/edit')}}/{{$value->id}}" type="button" class="btn btn-danger">
            ...
            $("#regForm").validate({
                rules: {
                    subject: {
                        required: true,
                        maxlength: 70,
                        remote:'/superadmin/validate-subject',
                    },
                    status: {
                        required: true,
                    }
