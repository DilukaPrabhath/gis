                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <a type="button" href="{{url('/superadmin/profile/update')}}" class="btn btn-danger waves-effect waves-light" style="margin-left: 5px;"><i class="mdi mdi-pencil-outline" style="margin-right: 5px;"></i>Update</a>
                                </div>
                            </div>
