                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="{{url('/superadmin/profile/edit/update')}}" method="POST" autocomplete="off" id="regForm" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group row float-right align-item-center mt-2">
                                                    <a type="button" style="margin-right: 10pt;" href="{{url('superadmin/profile/password/edit')}}" class="btn btn-danger align-self-right report-btn">Update Password</a>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12" style="margin-left: 10px;">
                                                    ...
                                                    <a type="button" href="{{url('superadmin/profile')}}" class="btn btn-primary waves-effect waves-light" style="margin-left: 5px;"><i class="mdi mdi-close" style="margin-right: 5px;"></i>Close</a>
                                                </div>
                                            </div>
                                        </div>
            ...
            $("#regForm").validate({
                rules: {
                    ...
                    email:{
                        ...
                        maxlength: 100,
                        remote: {
                          url: '/superadmin/profile_update_email',
                            type: 'post',
                    ...
                    nic: {
                        required: true,
                        remote: {
                          url: '/superadmin/profile_update_nic',
                            type: 'post',
                            headers:{'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                            data: {
                                'sid': $('#sid').val()
                    ...
                    mobile: {
                        ...
                        number: true,
                        remote: {
                          url: '/superadmin/profile_update_mobile',
                            type: 'post',
                            headers:{'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                            data: {
                                'sid': $('#sid').val()
