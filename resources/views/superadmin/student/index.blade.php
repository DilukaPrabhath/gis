                            ...
                            <tbody>
                                @foreach ($reg as $value)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{url('superadmin/school/student/view')}}/{{$value->id}}" type="button" class="btn btn-dropbox">
                                                    <i class="fab far fa-eye" style="color: white; font-size:8px;"></i>
                                                </a>
                                                <a href="{{url('superadmin/school/student/edit')}}/{{$value->id}}" type="button" class="btn btn-danger">
