                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <a type="button" href="{{url('superadmin/school/students/table')}}" class="btn btn-primary waves-effect waves-light" style="margin-left: 5px;"><i class="mdi mdi-close" style="margin-right: 5px;"></i>Close</a>
                            ...
                            <div class="tab-pane p-3" id="profile-1" role="tabpanel">
                                <form action="{{url('/superadmin/applications/update')}}/{{$data->id}}" method="POST" autocomplete="off" id="regForm2"  enctype="multipart/form-data" >
                                    @csrf
                                <div class="row">
                            ...
                            <div class="tab-pane p-3" id="settings-1" role="tabpanel">
                                <form action="{{url('/superadmin/school/student/update/')}}/{{$data->id}}" method="POST" autocomplete="off" id="regForm3"  enctype="multipart/form-data" >
                                    @csrf
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" type="text" value="{{$data->pre_school_id}}" name="gis_sid" id="gis_sid">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea class="form-control" rows="2" id="recod" name="recod">{{$data->recod}}</textarea>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <a type="button" href="{{url('superadmin/school/students/table')}}" class="btn btn-primary waves-effect waves-light"><i class="mdi mdi-close" style="margin-right: 5px;"></i>Close</a>
                                        </div>
                                    </div>
                                </div>
                                </form>
...
$('#father_nic').autocomplete({
    ...
    source: function(request, response) {
      $.getJSON("{{ url('/superadmin/student/parent2_nic') }}",
...
$('#st_id').autocomplete({
 ...
 source: function(request, response) {
   $.getJSON("{{ url('/superadmin/student/siblins') }}",
    {st_id:$("#st_id").val()},
       response);
 },
 minLength: 1,
...
function addTabledata(){
  ...
  $.ajax({
      type:"POST",
      url:"{{ url('/superadmin/sibilin_temp_insert') }}",
      async:false,
...
<script>
  ...
  $('#rsrvtbl').on('click', '.delete', function(e) {
    ...
    $.ajax({
      type:"POST",
      url:"{{ url('/superadmin/temp_sib_remove') }}",
      async:false,
...
$(document).ready(function() {   //same as: $(function() {
    // alert("hi 1");
     ...
     $.ajax({
      type:"POST",
      url:"{{ url('/superadmin/lord_temp_edit_syblin_tbl') }}",
      async:false,
      data:{"ttn1":ttn1, "ttn2":ttn2},
      headers:{'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
      beforeSend: function(){
      },
      success: function(data){
        ...
        //   $("#pmd1").val('');
        //   $("#embrid").val('');
        //   $('#emit').selectpicker('refresh');
        //   $('#emisel').selectpicker('refresh');
        //   $('#pmd1').selectpicker('refresh');
        //   $('#embrid').selectpicker('refresh');
        //   setTimeout(function() { $('#bpm').focus() });
