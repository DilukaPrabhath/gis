            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{url('/superadmin/event_tickets/store')}}" method="POST" autocomplete="off" id="regForm" enctype="multipart/form-data">
                            @csrf
            ...
            $("#regForm").validate({
                rules: {
                    ticket_category: {
                        ...
                        maxlength: 70,
                        remote: {
                             url: "/superadmin/check_ticket_category",
                             type: "get",
                             data: {"id" : id},
                                }
                    },
