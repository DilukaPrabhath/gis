            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{url('superadmin/institutes/update')}}/{{$value->id}}" method="POST" autocomplete="off" id="regForm" enctype="multipart/form-data">
                            @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <a type="button" href="{{url('superadmin/institutes')}}" class="btn btn-primary waves-effect waves-light" style="margin-left: 5px;"><i class="mdi mdi-close" style="margin-right: 5px;"></i>Close</a>
                                </div>
                            </div>
                        </form>
                        </div>
            ...
            $("#regForm").validate({
                ...
                rules: {
                    institute_name: {
                        ...
                        maxlength: 150,
                        remote: {
                          url: '/superadmin/validate_ins_name_edit',
                            type: 'post',
                    ...
                    ins_email:{
                        ...
                        maxlength: 100,
                        remote: {
                          url: '/superadmin/validate_ins_mail_edit',
                            type: 'post',
                            headers:{'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                            data: {
                                'i_id': $('#i_id').val()
                    ...
                    con_number: {
                        ...
                        number: true,
                        remote: {
                          url: '/superadmin/validate_ins_cont_edit',
                            type: 'post',
                            headers:{'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                            data: {
                                'i_id': $('#i_id').val()
                    ...
                    code: {
                        remote: {
                          url: '/superadmin/validate_code_edit',
                            type: 'post',
                            headers:{'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                            data: {
                                'i_id': $('#i_id').val()
