                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <a type="button" href="{{url('superadmin/activities_pay')}}" class="btn btn-primary waves-effect waves-light" style="margin-left: 5px;"><i class="mdi mdi-close" style="margin-right: 5px;"></i>Close</a>
                                    </div>
                                </div>
                    ...
                    <div class="card-body">
                        ...
                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tr>
                                ...
                                <td>2021/01/10</td>
                                <td>
                                    <a href="{{url('superadmin/activities_pay/old/view')}}" type="button" class="btn btn-dropbox">
