            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="mt-0 header-title">Income Reports</h4>
                            ...
                            <form action="{{url('superadmin/income/date')}}" method="POST" autocomplete="off" id="regForm1" enctype="multipart/form-data">
                                @csrf
                            ...
                            <form action="{{url('superadmin/income/daterange')}}" method="POST" autocomplete="off" id="regForm2" enctype="multipart/form-data">
                                @csrf
