                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="mt-0 header-title">Due Payment Reports</h4>
                            ...
                            <form action="{{url('superadmin/duefee/date')}}" method="POST" autocomplete="off" id="regForm1" enctype="multipart/form-data">
                                @csrf
                            ...
                            <form action="{{url('superadmin/duefee/daterange')}}" method="POST" autocomplete="off" id="regForm2" enctype="multipart/form-data">
                                @csrf
                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$value->due_fee - $value->paid_amount}}</td>
                                    <td>@php
                                        $newDateTime = date('Y-m-d h:i A', strtotime($value->last_payment_time));
                                        @endphp
                                       {{ $newDateTime }}</td>
                                </tr>
                                @endforeach
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("#regForm1").validate({
                ...
                messages: {
                    school_date: {
                        required: "Month Count is required",
                    }
                }
            });
