                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="mt-0 header-title">Admition Reports</h4>
                            ...
                            <form action="{{url('/superadmin/reports/admition/date_vise')}}" method="POST" autocomplete="off" id="regForm1" enctype="multipart/form-data">
                                @csrf
                            ...
                            <form action="{{url('/superadmin/reports/admition/daterange')}}" method="POST" autocomplete="off" id="regForm2" enctype="multipart/form-data">
                                @csrf
