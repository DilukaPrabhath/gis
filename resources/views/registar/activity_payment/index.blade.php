...
<div class="page-content">
                            ...
                            <tbody>
                                @foreach ($tbl as $value)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{url('registar/activities_payments/print')}}/{{$value->id}}" target="_blank" type="button" class="btn btn-dropbox">
    ...
    <div class="float-right align-item-center mt-2">
        <a href="{{url('registar/activities_payments/create')}}" class="btn btn-info px-4 align-self-center report-btn">Add</a>
    </div>
    @stop
