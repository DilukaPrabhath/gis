            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{url('/registar/complaints/store')}}" method="POST" autocomplete="off" id="regForm" enctype="multipart/form-data">
                            @csrf
...
<script>
    ...
    $('#stu_id').autocomplete({
        ...
        source: function(request, response) {
          $.getJSON("{{ url('/registar/complaints/students/search') }}",
           {stu_id:$("#stu_id").val()},
              response);
        },
        minLength: 1,
