                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <a type="button" href="{{url('registar/inqueries')}}" class="btn btn-primary waves-effect waves-light" style="margin-left: 5px;"><i class="mdi mdi-close" style="margin-right: 5px;"></i>Close</a>
                            ...
                            <div class="tab-pane p-3" id="settings-1" role="tabpanel">
                                <form action="{{url('/registar/inqueries/registration/update')}}/{{$data->id}}" method="POST" autocomplete="off" id="regForm3"  enctype="multipart/form-data" >
                                    @csrf
                                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <a type="button" href="{{url('registar/students')}}" class="btn btn-primary waves-effect waves-light"><i class="mdi mdi-close" style="margin-right: 5px;"></i>Close</a>
                                        </div>
                                    </div>
                                </div>
                                </form>
