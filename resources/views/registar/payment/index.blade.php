...
{{--
                            ...
                            <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{url('registar/student_pay_print')}}/{{$value->id}}" target="_blank" type="button" class="btn btn-dropbox">
    ...
    <div class="float-right align-item-center mt-2">
        <a href="{{url('registar/payments/create')}}" class="btn btn-info px-4 align-self-center report-btn">Add</a>
    </div>
    @stop
