                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="{{url('/registar/profile/edit/update')}}" method="POST" autocomplete="off" id="regForm" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group row float-right align-item-center mt-2">
                                                    <a type="button" style="margin-right: 10pt;" href="{{url('registar/profile/password/edit')}}" class="btn btn-danger align-self-right report-btn">Update Password</a>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12" style="margin-left: 10px;">
                                                    ...
                                                    <a type="button" href="{{url('registar/profile')}}" class="btn btn-primary waves-effect waves-light" style="margin-left: 5px;"><i class="mdi mdi-close" style="margin-right: 5px;"></i>Close</a>
                                                </div>
                                            </div>
                                        </div>
