                            ...
                            <tbody>
                                @foreach ($tbl as $value)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{url('registar/application_pay/print')}}/{{$value->id}}" type="button" class="btn btn-dropbox">
                                                    <i class="fab far fa-eye" style="color: white; font-size:8px;"></i>
                                                </a>
                                                {{-- <a href="{{url::to(registar/application_pay/print/.$value->id)}}" type="button" class="btn btn-danger">
