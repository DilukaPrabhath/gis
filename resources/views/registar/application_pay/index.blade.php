...
<div class="page-content">
                            ...
                            <tbody>
                                @foreach ($tbl as $value)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{url('registar/application_pay/print')}}/{{$value->id}}" target="_blank" type="button" class="btn btn-dropbox">
                                                    <i class="fab far fa-eye" style="color: white; font-size:8px;"></i>
                                                </a>
                                                {{-- <a href="{{url('registar/application_pay/print')}}/{{$value->id}}" type="button" class="btnprint">
                                                    <i class="fab far fa-eye" style="color: white; font-size:8px;"></i>jj
                                                </a> --}}
                                                <a href="{{url('registar/application_pay/print')}}" target="_blank" type="button" class="btn btn-danger">
    ...
    <div class="float-right align-item-center mt-2">
        <a href="{{url('registar/application_pay/create')}}" class="btn btn-info px-4 align-self-center report-btn">Add</a>
    </div>
    @stop
