...
<div class="page-content">
                            ...
                            <tbody>
                                @foreach ($app as $value)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{url('registar/inqueries/view')}}/{{$value->id}}" type="button" class="btn btn-dropbox">
                                                    <i class="fab far fa-eye" style="color: white; font-size:8px;"></i>
                                                </a>
                                                {{-- <a href="{{url('registar/inqueries/edit')}}/{{$value->id}}" type="button" class="btn btn-danger">
    ...
    <div class="float-right align-item-center mt-2">
        <a href="{{url('registar/inqueries/create')}}" class="btn btn-info px-4 align-self-center report-btn">Add</a>
    </div>
    @stop
