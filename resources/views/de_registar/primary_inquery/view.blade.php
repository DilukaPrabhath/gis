                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <a type="button" href="{{url('de_registar/primary/inqueries')}}" class="btn btn-primary waves-effect waves-light" style="margin-left: 5px;"><i class="mdi mdi-close" style="margin-right: 5px;"></i>Close</a>
                            ...
                            <div class="tab-pane p-3" id="profile-1" role="tabpanel">
                                <form action="{{url('/de_registar/primary/applications/update')}}/{{$data->id}}" method="POST" autocomplete="off" id="regForm2"  enctype="multipart/form-data" >
                                    @csrf
                                <div class="row">
                                    <div class="col-lg-6">
                            ...
                            <div class="tab-pane p-3" id="settings-1" role="tabpanel">
                                <form action="{{url('/de_registar/primary/inqueries/registration/update')}}/{{$data->id}}" method="POST" autocomplete="off" id="regForm3"  enctype="multipart/form-data" >
                                    @csrf
                                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <a type="button" href="{{url('de_registar/primary/inqueries')}}" class="btn btn-primary waves-effect waves-light"><i class="mdi mdi-close" style="margin-right: 5px;"></i>Close</a>
                                        </div>
                                    </div>
                                </div>
                                </form>
...
$('#st_id').autocomplete({
 ...
 source: function(request, response) {
   $.getJSON("{{ url('/de_registar/student/siblins') }}",
    {st_id:$("#st_id").val()},
       response);
 },
 minLength: 1,
...
function addTabledata(){
  ...
  $.ajax({
      type:"POST",
      url:"{{ url('/de_registar/sibilin_temp_insert') }}",
      async:false,
...
<script>
  ...
  $('#rsrvtbl').on('click', '.delete', function(e) {
    ...
    $.ajax({
      type:"POST",
      url:"{{ url('/de_registar/temp_sib_remove') }}",
      async:false,
