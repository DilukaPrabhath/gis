...
<div class="page-content">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{url('de_registar/activities_payments/store')}}" method="POST" autocomplete="off" id="regForm" enctype="multipart/form-data">
                            @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <a type="button" href="{{url('de_registar/activities_payments/create')}}" class="btn btn-primary waves-effect waves-light" style="margin-left: 5px;"><i class="mdi mdi-close" style="margin-right: 5px;"></i>Close</a>
                                </div>
                            </div>
                        </div>
                        </form>
            ...
            $("#regForm").validate({
                rules: {
                    st_id_num: {
                        required: true,
                        maxlength: 15,
                        remote:'/de_registar/validate-activity-pay',
                    },
                    activity: {
                        required: true,
                    },
    ...
    $(document).on('change', '#activity', function() {
        ...
        $.ajax({
            type: 'post',
            url: '{{ url('/de_registar/activity_price_get') }}',
            data: {'id':activity_id},
...
<script>
    ...
    $('#st_id_num').autocomplete({
        ...
        source: function(request, response) {
          $.getJSON("{{ url('/de_registar/student_id') }}",
