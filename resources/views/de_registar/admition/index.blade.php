...
<div class="page-content">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="mt-0 header-title">Admission Payment Table</h4>
                            ...
                            <tbody>
                                @foreach ($data as $value)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{url('de_registar/admition/print')}}/{{$value->id}}" target="_blank" type="button" class="btn btn-dropbox">
    ...
    <div class="float-right align-item-center mt-2">
        <a href="{{url('de_registar/admition/create')}}" class="btn btn-info px-4 align-self-center report-btn">Add</a>
    </div>
    @stop
