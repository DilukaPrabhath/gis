            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{url('/de_registar/banks/store')}}" method="POST" autocomplete="off" id="regForm" enctype="multipart/form-data">
                            @csrf
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" value="" name="bank_name" id="bank_name">
                                        @error('bank_name')
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <a type="button" href="{{url('/de_registar/banks')}}" class="btn btn-primary waves-effect waves-light" style="margin-left: 5px;"><i class="mdi mdi-close" style="margin-right: 5px;"></i>Close</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{url('de_registar/banks/edit')}}/{{$value->id}}" type="button" class="btn btn-danger">
            ...
            $("#regForm").validate({
                rules: {
                    bank_name: {
                        required: true,
                        maxlength: 100,
                        remote:'/de_registar/validate-bank',
                    },
                    status: {
                        required: true,
                    }
