...
<div class="page-content">
                    ...
                    <div class="card-body">
                        ...
                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{url('de_registar/event_tickets/create')}}/{{$value->id}}" type="button" class="btn btn-warning sm">
                                        <i class="fab fa fa-plus" style="color: white; font-size: 8px;"></i></a>
                                    </a>
                                    <a href="{{url('de_registar/event_tickets/view')}}/{{$value->id}}" type="button" class="btn btn-dropbox">
    ...
    {{-- <div class="float-right align-item-center mt-2">
        <a href="{{url('/de_registar/event_tickets/create')}}" class="btn btn-info px-4 align-self-center report-btn">Add</a>
    </div> --}}
    @stop
