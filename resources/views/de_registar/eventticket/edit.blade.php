            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{url('/de_registar/event_tickets/update')}}/{{$evid}}/{{$t_id}}" method="POST" autocomplete="off" id="regForm" enctype="multipart/form-data">
                            @csrf
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="text" value="{{$ticedit->ticket_category}}" name="ticket_category" id="ticket_category">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="number" value="{{$ticedit->price}}" name="price" id="price">
                                        @error('price')
                                        <div class="alert" style="color: #f93b7a;padding-left: 0px;">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" type="number" value="{{$ticedit->max_count}}" name="max_count" id="max_count">
                                        @error('max_count')
                                        <div class="alert" style="color: #f93b7a;padding-left: 0px;">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control" name="status" id="status">
                                            ...
                                            <option value="1" {{$ticedit->status=='1'?'selected':''}}>Active</option>
                                            <option value="2" {{$ticedit->status=='2'?'selected':''}}>Inactive</option>
                                            <option value="3" {{$ticedit->status=='3'?'selected':''}}>Sold Out</option>
                                        </select>
                                        @error('status')
                                        <div class="alert" style="color: #f93b7a;padding-left: 0px;">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <a type="button" href="{{url('de_registar/event_tickets')}}" class="btn btn-primary waves-effect waves-light" style="margin-left: 5px;"><i class="mdi mdi-close" style="margin-right: 5px;"></i>Close</a>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{url('de_registar/event_tickets/edit')}}/{{$value->evt_id}}/{{$value->id}}" type="button" class="btn btn-danger">
