            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{url('/de_registar/event_tickets/store')}}" method="POST" autocomplete="off" id="regForm" enctype="multipart/form-data">
                            @csrf
            ...
            $("#regForm").validate({
                rules: {
                    ticket_category: {
                        ...
                        maxlength: 70,
                        remote: {
                             url: "/de_registar/check_ticket_category",
                             type: "get",
                             data: {"id" : id},
                                }
                    },
