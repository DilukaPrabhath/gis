            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{url('de_registar/activities/update')}}/{{$data->id}}" method="POST" autocomplete="off" id="regForm" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{url('de_registar/classfee/edit')}}/{{$value->id}}" type="button" class="btn btn-danger">
