            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{url('de_registar/activity/store')}}" method="POST" autocomplete="off" id="regForm" enctype="multipart/form-data">
                            @csrf
                        ...
                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{url('de_registar/activities/edit')}}/{{$value->id}}" type="button" class="btn btn-danger">
            ...
            $("#regForm").validate({
                rules: {
                    activity: {
                        required: true,
                        maxlength: 100,
                        remote:'/de_registar/validate-activity',
                    },
                    price:{
                        number: true,
                        required: true
