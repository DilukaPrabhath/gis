                        ...
                        <div class="tab-content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <a type="button" href="{{url('de_registar/student/profile')}}" class="btn btn-primary waves-effect waves-light" style="margin-left: 5px;"><i class="mdi mdi-close" style="margin-right: 5px;"></i>Close</a>
                            ...
                            <div class="tab-pane p-3" id="settings-1" role="tabpanel">
                                <div class="row">
                                    ...
                                    <a type="button" href="{{url('de_registar/student/profile')}}" class="btn btn-primary waves-effect waves-light"><i class="mdi mdi-close" style="margin-right: 5px;"></i>Close</a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <table class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{$acc->title}}</td>
                                    {{-- <td>
                                        <a href="{{url('de_registar/students/awards/view')}}/{{$acc->id}}" type="button" class="btn btn-dropbox">
                        ...
                        <table class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{$no_acc->title}}</td>
                                    {{-- <td>
                                        <a href="{{url('/de_registar/nonacc/students/awards/view')}}/{{$no_acc->id}}" type="button" class="btn btn-dropbox">
                                            <i class="fab far fa-eye" style="color: white; font-size:8px;"></i>
                                        </a>
                        ...
                        <table id="datatable2" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{$com->title}}</td>
                                    {{-- <td>
                                        <a href="{{url('de_registar/students/complaints/view')}}/{{$com->title}}" type="button" class="btn btn-dropbox">
                                            <i class="fab far fa-eye" style="color: white; font-size:8px;"></i>
                                        </a>
...
<script>
    ...
    $('#rnum').autocomplete({
        ...
        source: function(request, response) {
          $.getJSON("{{ url('/de_registar/student/profile/id') }}",
           {rnum:$("#rnum").val()},
              response);
        },
        minLength: 1,
