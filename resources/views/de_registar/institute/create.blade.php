            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{url('de_registar/institutes/store')}}" method="POST" autocomplete="off" id="regForm" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                            <div class="col-lg-6">
            ...
            $("#regForm").validate({
                rules: {
                    name: {
                        required: true,
                        maxlength: 150,
                        remote:'/de_registar/validate-name',
                    },
                    email:{
                        email: true,
                        required: true,
                        maxlength: 100,
                        remote:'/de_registar/validate-email',
                    },
                    phone: {
                        required: true,
                        minlength: 10,
                        maxlength: 10,
                        number: true,
                        remote:'/de_registar/validate-phone',
                    },
                    address_line_1: {
                        required: true,
                    },
                    ...
                    code: {
                        remote:'/de_registar/validate-code',
                        maxlength: 3,
                        required: function () {
                                if($("#pre_or_sch").val() == 1){
                                    return true;
