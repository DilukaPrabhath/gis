                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="mt-0 header-title">Admission Reports</h4>
                            ...
                            <form action="{{url('/accountant/reports/admition/date_vise')}}" method="POST" autocomplete="off" id="regForm1" enctype="multipart/form-data">
                                @csrf
                            ...
                            <form action="{{url('/accountant/reports/admition/daterange')}}" method="POST" autocomplete="off" id="regForm2" enctype="multipart/form-data">
                                @csrf
