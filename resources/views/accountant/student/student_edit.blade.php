                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <a type="button" href="{{url('accountant/school/students/table')}}" class="btn btn-primary waves-effect waves-light" style="margin-left: 5px;"><i class="mdi mdi-close" style="margin-right: 5px;"></i>Close</a>
                            ...
                            <div class="tab-pane p-3" id="profile-1" role="tabpanel">
                                <form action="{{url('/accountant/applications/update')}}/{{$data->id}}" method="POST" autocomplete="off" id="regForm2"  enctype="multipart/form-data" >
                                    @csrf
                                <div class="row">
                            ...
                            <div class="tab-pane p-3" id="settings-1" role="tabpanel">
                                <form action="{{url('/accountant/school/student/update/')}}/{{$data->id}}" method="POST" autocomplete="off" id="regForm3"  enctype="multipart/form-data" >
                                    @csrf
                                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <a type="button" href="{{url('accountant/school/students/table')}}" class="btn btn-primary waves-effect waves-light"><i class="mdi mdi-close" style="margin-right: 5px;"></i>Close</a>
                                        </div>
                                    </div>
                                </div>
                                </form>
...
$('#st_id').autocomplete({
 ...
 source: function(request, response) {
   $.getJSON("{{ url('/accountant/student/siblins') }}",
    {st_id:$("#st_id").val()},
       response);
 },
 minLength: 1,
...
function addTabledata(){
  ...
  $.ajax({
      type:"POST",
      url:"{{ url('/accountant/sibilin_temp_insert') }}",
      async:false,
...
<script>
  ...
  $('#rsrvtbl').on('click', '.delete', function(e) {
    ...
    $.ajax({
      type:"POST",
      url:"{{ url('/accountant/temp_sib_remove') }}",
      async:false,
...
$(document).ready(function() {   //same as: $(function() {
    // alert("hi 1");
     ...
     $.ajax({
      type:"POST",
      url:"{{ url('/accountant/lord_temp_edit_syblin_tbl') }}",
      async:false,
