                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane p-3" id="settings-1" role="tabpanel">
                                <div class="row">
                                    ...
                                    <a type="button" href="{{url('accountant/students')}}" class="btn btn-primary waves-effect waves-light"><i class="mdi mdi-close" style="margin-right: 5px;"></i>Close</a>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{url('accountant/students/awards/view')}}" type="button" class="btn btn-dropbox">
                                        <i class="fab far fa-eye" style="color: white; font-size:8px;"></i>
                                    </a>
                                    <a href="{{url('accountant/students/awards/edit')}}" type="button" class="btn btn-danger">
                    ...
                    <div class="card-body">
                        ...
                        <table id="datatable2" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{url('accountant/students/complaints/view')}}" type="button" class="btn btn-dropbox">
                                        <i class="fab far fa-eye" style="color: white; font-size:8px;"></i>
                                    </a>
                                    <a href="{{url('accountant/students/complaints/edit')}}" type="button" class="btn btn-danger">
                                        <i class="fab fas fa-pencil-alt" style="color: white; font-size:8px;"></i>
                                    </a>
                                </td>
                            </tr>
