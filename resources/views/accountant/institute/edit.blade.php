            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{url('accountant/institutes/update')}}/{{$value->id}}" method="POST" autocomplete="off" id="regForm" enctype="multipart/form-data">
                            @csrf
            ...
            $("#regForm").validate({
                ...
                rules: {
                    institute_name: {
                        ...
                        maxlength: 150,
                        remote: {
                          url: '/accountant/validate_ins_name_edit',
                            type: 'post',
                    ...
                    ins_email:{
                        ...
                        maxlength: 100,
                        remote: {
                          url: '/accountant/validate_ins_mail_edit',
                            type: 'post',
                            headers:{'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                            data: {
                                'i_id': $('#i_id').val()
                    ...
                    con_number: {
                        ...
                        number: true,
                        remote: {
                          url: '/accountant/validate_ins_cont_edit',
                            type: 'post',
                            headers:{'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                            data: {
                                'i_id': $('#i_id').val()
                    ...
                    code: {
                        remote: {
                          url: '/accountant/validate_code_edit',
                            type: 'post',
                            headers:{'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                            data: {
                                'i_id': $('#i_id').val()
