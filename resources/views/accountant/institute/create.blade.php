            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{url('accountant/institutes/store')}}" method="POST" autocomplete="off" id="regForm" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                            <div class="col-lg-6">
            ...
            $("#regForm").validate({
                rules: {
                    name: {
                        required: true,
                        maxlength: 150,
                        remote:'/accountant/validate-name',
                    },
                    email:{
                        email: true,
                        required: true,
                        maxlength: 100,
                        remote:'/accountant/validate-email',
                    },
                    phone: {
                        required: true,
                        minlength: 10,
                        maxlength: 10,
                        number: true,
                        remote:'/accountant/validate-phone',
                    },
                    address_line_1: {
                        required: true,
                    },
