...
<div class="page-content">
                            ...
                            <tbody>
                                @foreach ($data as $value)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{url('accountant/admition/print')}}/{{$value->id}}" target="_blank" type="button" class="btn btn-dropbox">
    ...
    <div class="float-right align-item-center mt-2">
        <a href="{{url('accountant/admition/create')}}" class="btn btn-info px-4 align-self-center report-btn">Add</a>
    </div>
    @stop
