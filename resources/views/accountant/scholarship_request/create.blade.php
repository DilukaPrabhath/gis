            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{url('accountant/scholarship/store')}}" method="POST" autocomplete="off" id="regForm" enctype="multipart/form-data">
                            @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <a type="button" href="{{url('accountant/scholarship')}}" class="btn btn-primary waves-effect waves-light" style="margin-left: 5px;"><i class="mdi mdi-close" style="margin-right: 5px;"></i>Close</a>
                                </div>
                            </div>
                        </div>
                        </form>
...
<script>
    ...
    $('#stu_id').autocomplete({
        ...
        source: function(request, response) {
          $.getJSON("{{ url('/accountant/sholarship_st_id_num') }}",
           {stu_id:$("#stu_id").val()},
              response);
        },
        minLength: 1,
