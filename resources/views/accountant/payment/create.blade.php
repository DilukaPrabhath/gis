...
<div class="page-content">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12">
                <form action="{{url('/accountant/payments/store')}}" method="POST" autocomplete="off" id="regForm" enctype="multipart/form-data">
                    @csrf
                    <div class="card">
                    <div class="card-body">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <a type="button" href="{{url('accountant/payments')}}" class="btn btn-primary waves-effect waves-light" style="margin-left: 5px;"><i class="mdi mdi-close" style="margin-right: 5px;"></i>Close</a>
                                    </div>
                                </div>
    ...
    $(document).ready(function(){
      ...
      function load_data(){
        ...
        if(stu_id == ''){
          ...
          $.ajax({
          type:"POST",
          url:"{{ url('/accountant/select_pay_student') }}",
          async:false,
          data:{"stu_id": stu_id},
    ...
    <script>
        ...
        $('#stu_id').autocomplete({
            ...
            source: function(request, response) {
              $.getJSON("{{ url('/accountant/class_st_id_num') }}",
               {stu_id:$("#stu_id").val()},
                  response);
            },
            minLength: 1,
