                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="{{url('/admin/profile/edit/update')}}" method="POST" autocomplete="off" id="regForm" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group row float-right align-item-center mt-2">
                                                    <a type="button" style="margin-right: 10pt;" href="{{url('admin/profile/password/edit')}}" class="btn btn-danger align-self-right report-btn">Update Password</a>
                                                </div>
