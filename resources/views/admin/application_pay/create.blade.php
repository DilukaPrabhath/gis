            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{url('admin/application_pay/store')}}" method="POST" autocomplete="off" id="regForm" enctype="multipart/form-data">
                            @csrf
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="form-group row">
                                    <label for="inq_num" class="col-sm-3 col-form-label text-right"><span style="color: #f93b7a">*</span>Inquery Number</label>
                                    <div class="col-sm-9">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <a type="button" href="{{url('admin/application_pay')}}" class="btn btn-primary waves-effect waves-light" style="margin-left: 5px;"><i class="mdi mdi-close" style="margin-right: 5px;"></i>Close</a>
                                </div>
                            </div>
                        </div>
                        </form>
