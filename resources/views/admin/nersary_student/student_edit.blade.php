                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane p-3" id="settings-1" role="tabpanel">
                                <form action="{{url('/admin/nursary/student/update')}}/{{$data->id}}" method="POST" autocomplete="off" id="regForm3"  enctype="multipart/form-data" >
                                    @csrf
                                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <a type="button" href="{{url('admin/nursary/student/grade/update')}}/{{$data->id}}" class="btn btn-danger waves-effect waves-light"><i class="mdi mdi-warning" style="margin-right: 5px;"></i>Update Grade</a>
