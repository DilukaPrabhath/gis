            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{url('/admin/nonacc/awards/store')}}" method="POST" autocomplete="off" id="regForm" enctype="multipart/form-data">
                            @csrf
...
<script>
    ...
    $('#stu_id').autocomplete({
        ...
        source: function(request, response) {
          $.getJSON("{{ url('/admin/nonacc/students/awards/search') }}",
           {stu_id:$("#stu_id").val()},
              response);
        },
        minLength: 1,
