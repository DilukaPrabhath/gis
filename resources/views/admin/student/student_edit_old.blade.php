                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane p-3" id="settings-1" role="tabpanel">
                                <form action="{{url('/admin/school/student/update/')}}/{{$data->id}}" method="POST" autocomplete="off" id="regForm3"  enctype="multipart/form-data" >
                                    @csrf
                                <div class="row">
...
$(document).ready(function() {   //same as: $(function() {
    // alert("hi 1");
     ...
     $.ajax({
      type:"POST",
      url:"{{ url('/lord_temp_edit_syblin_tbl') }}",
      async:false,
