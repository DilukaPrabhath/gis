    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="mt-0 header-title">Create Nursery Grade</h4>
                        <form action="{{url('admin/nursery_grade/store')}}" method="POST" autocomplete="off" id="regForm" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <select class="form-control" name="nursery_class_id" id="nursery_class_id">
                                        ...
                                        @foreach ($data as $val)
                                        <option value="{{$val->id}}">{{$val->nursery_class_name}}</option>
                                        @endforeach
                                    </select>
               ...
               // var class_id = $('#nursery_class_name').val();
                rules: {
                    grade_name: {
                        ...
                        maxlength: 70,
                        remote:{
                            url:'/validate-nursery_grade_name',
                            // data: {'class_id': class_id},
                            data: {'class_id':function(){return $('#nursery_class_id').val()}},
                            async:false
                        }
                    },
                    nursery_class_id: {
