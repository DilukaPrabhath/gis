...
<div class="page-content">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12">
                <form action="{{url('/admin/nursary/grade_type/update')}}/{{$id}}/{{$gd_id}}" method="POST" autocomplete="off" id="regForm" enctype="multipart/form-data">
                    @csrf
                    <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" id="grade_types_name" value="{{$gd_type->grade_types_name}}" name="grade_types_name" class="form-control">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control" id="status" name="status">
                                            ...
                                            <option value="1" {{$gd_type['status']=='1'?'selected':''}}>Active</option>
                                            <option value="0" {{$gd_type['status']=='0'?'selected':''}}>Deactive</option>
                                        </select>
                                        @error('status')
                                        <div class="alert" style="color: #f93b7a;padding-left: 0px;">{{ $message }}</div>
                                        @enderror
