    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="mt-0 header-title">Edit Nursery Classes</h4>
                        <form action="{{url('admin/nursery_classes/update_class')}}/{{$data->id}}" method="POST" autocomplete="off" id="regForm" enctype="multipart/form-data">
                            @csrf
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" type="text" value="{{$data->nursery_class_name}}" name="nursery_class_name" id="nursery_class_name">
                                    </div>
