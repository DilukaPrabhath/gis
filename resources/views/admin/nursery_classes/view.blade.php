    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="mt-0 header-title">View Nursery Classes</h4>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input class="form-control" type="text" value="{{$data->nursery_class_name}}" readonly name="nursery_class_name" id="nursery_class_name">
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                    <select class="form-control" name="nursery_class_status" id="nursery_class_status" disabled>
