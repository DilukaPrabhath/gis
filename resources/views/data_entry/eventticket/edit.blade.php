            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{url('/data_entry/event_tickets/update')}}/{{$evid}}/{{$t_id}}" method="POST" autocomplete="off" id="regForm" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <a type="button" href="{{url('data_entry/event_tickets')}}" class="btn btn-primary waves-effect waves-light" style="margin-left: 5px;"><i class="mdi mdi-close" style="margin-right: 5px;"></i>Close</a>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{url('data_entry/event_tickets/edit')}}/{{$value->evt_id}}/{{$value->id}}" type="button" class="btn btn-danger">
