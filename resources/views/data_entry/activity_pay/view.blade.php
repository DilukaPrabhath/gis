                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <a type="button" href="{{url('data_entry/activities_pay')}}" class="btn btn-primary waves-effect waves-light" style="margin-left: 15px;"><i class="mdi mdi-close" style="margin-right: 5px;"></i>Close</a>
                                </div>
                            </div>
