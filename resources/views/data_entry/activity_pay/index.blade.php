...
<div class="page-content">
                        ...
                        <table class="table table-bordered mb-0 table-centered" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <td>2021/06/10</td>
                                    <td>
                                        <a href="{{url('data_entry/activities_pay/view')}}" type="button" class="btn btn-dropbox">
    ...
    <div class="float-right align-item-center mt-2">
        <a href="{{url('data_entry/activities_pay/create')}}" class="btn btn-info px-4 align-self-center report-btn">Add</a>
    </div>
    @stop
