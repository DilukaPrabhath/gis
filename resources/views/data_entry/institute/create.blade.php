            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{url('data_entry/institutes/store')}}" method="POST" autocomplete="off" id="regForm" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                            <div class="col-lg-6">
            ...
            $("#regForm").validate({
                rules: {
                    name: {
                        required: true,
                        maxlength: 150,
                        remote:'/data_entry/validate-name',
                    },
                    email:{
                        email: true,
                        required: true,
                    ...
                    phone: {
                        ...
                        maxlength: 10,
                        number: true,
                        remote:'/data_entry/validate-phone',
                    },
                    address_line_1: {
                        required: true,
                    },
                    ...
                    code: {
                        remote:'/data_entry/validate-code',
                        maxlength: 3,
                        required: function () {
                                if($("#pre_or_sch").val() == 1){
                                    return true;
