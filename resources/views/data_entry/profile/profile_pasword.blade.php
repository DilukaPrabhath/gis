    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card">
                        <form action="{{url('data_entry/profile/password/update')}}" method="POST" autocomplete="off" id="regForm" enctype="multipart/form-data">
                            @csrf
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                {{-- <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <a type="button" href="{{url('data_entry/users/edit')}}" class="btn btn-primary waves-effect waves-light" style="margin-left: 5px;"><i class="fas fa-chevron-left" style="margin-right: 5px;"></i>Back</a>
                                    </div>
                                </div> --}}
                            </div>
