            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{url('data_entry/users/store')}}" method="POST" autocomplete="off" id="regForm" enctype="multipart/form-data">
                            @csrf
                        <div class="row">
                            <div class="col-lg-6">
            ...
            $("#regForm").validate({
                rules: {
                    ...
                    email:{
                        ...
                        required: true,
                        maxlength: 100,
                        remote:'/data_entry/validate-email',
                    },
                    nic: {
                        required: true,
                        remote:'/validate-nic',
                    ...
                    mobile: {
                        ...
                        maxlength: 10,
                        number: true,
                        remote:'/data_entry/validate-mobile',
                    },
                    usertype: {
                        required: true,
                    },
