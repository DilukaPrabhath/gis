                    ...
                    <div class="card-body">
                        ...
                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{url('data_entry/classfee/create')}}/{{$value->id}}" type="button" class="btn btn-warning sm">
                                        <i class="fab fa fa-plus" style="color: white; font-size: 8px;"></i></a>
                                    </a>
                                    <a href="{{url('data_entry/classfee/view')}}/{{$value->id}}" type="button" class="btn btn-dropbox">
