...
<div class="page-content">
                        ...
                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{url('/data_entry/events/view')}}/{{$value->id}}" type="button" class="btn btn-dropbox">
                                            <i class="fab far fa-eye" style="color: white; font-size:8px;"></i>
                                        </a>
                                        <a href="{{url('data_entry/events/edit')}}/{{$value->id}}" type="button" class="btn btn-danger">
    ...
    <div class="float-right align-item-center mt-2">
        <a href="{{url('data_entry/events/create')}}" class="btn btn-info px-4 align-self-center report-btn">Add</a>
    </div>
    @stop
